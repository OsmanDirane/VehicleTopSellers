...
if(isset($_POST['Submit'])){
    ...
    $query = "INSERT INTO sedan VALUES ('$code', '$model', '$price')";
     mysqli_query($con, $query);

     header('Location: ../php/sedan.php');
   }
}
?>
  ...
  <form id="form" action="addsedan.php" method="POST" >
  ...
  <input type="submit" id="submit" value="Add New Sedan" name="Submit">
